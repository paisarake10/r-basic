...
Esto es un texto llano. Podemos escribir sin ningún problema todo el texto que queramos para acompañar a tanto el código en `R` como las fórmulas en $\text{LaTeX}$. 
...
se instala paquete kableextra() que es muy bueno tambien para con lenguaje de marcado crear tablas cool cuya documentacion se encuentra [aquí](https://bookdown.org/yihui/rmarkdown-cookbook/kableextra.html)
